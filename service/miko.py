...
class MikoConfig(object):
    ...
    def changelist_view(self, request):
        ...
        # ##### 处理分页 #####
        from miko.utils.pagination import Pagination
        ...
        return render(request, 'miko/changelist.html', context)
    ...
    def add_view(self, request):
        ...
        if request.method == "GET":
            form = AddModelForm()
            return render(request, 'miko/change.html', {'form': form})
    ...
    def delete_view(self, request, pk):
        ...
        """
        if request.method == "GET":
            return render(request, 'miko/delete.html', {'cancel_url': self.reverse_list_url()})
